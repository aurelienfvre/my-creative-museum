    ...
    <main id="main">
      <HomeMotion>
        <section className="home-cover page-gutter relative grid grid-cols-1 gap-8 pt-8 pb-12 lg:grid-cols-[0.95fr_1.1fr] lg:pt-12 lg:pb-20">
          ...
          <figure className="home-cover-work m-0 pt-0 lg:pt-[2.4rem]">
            <TransitionLink
      ...
      <section className="home-manifesto page-gutter grid grid-cols-1 gap-8 py-12 text-ink lg:grid-cols-[1fr_3fr] lg:gap-16 lg:py-24">
