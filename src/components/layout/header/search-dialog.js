...
export default function SearchDialog({
  ...
  return (
    ...
    <dialog
      className="search-dialog fixed inset-x-0 mx-auto mt-8 mb-auto max-h-none w-[calc(100vw_-_2rem)] max-w-none overflow-hidden border-0 bg-background p-0 text-ink backdrop:bg-[rgb(20_25_30/0.48)] backdrop:backdrop-blur-[5px] backdrop:opacity-[var(--search-backdrop,1)] lg:mt-24 lg:w-[min(44rem,90vw)]"
      ref={dialog}
