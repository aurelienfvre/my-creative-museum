...
export default function ScrollGallery({ works }) {
  ...
  return (
    <section
      ref={scope}
      className="scroll-gallery page-gutter relative bg-background py-12"
    ...
    >
      ...
      <div className="scroll-gallery-stage relative grid grid-cols-1 items-center gap-4 lg:grid-cols-[1fr_minmax(0,62vw)_1fr] lg:gap-8">
        <div
          className="scroll-counter hidden font-mono text-[.8rem]"
          aria-hidden="true"
        >
        ...
        <div className="scroll-frames">
          {works.map((work) => (
            <TransitionLink
              ...
              className="scroll-work mb-8 block"
              data-cursor="artwork"
            ...
            >
              ...
              />
              <span className="scroll-static-caption mt-[.8rem] block text-[.8rem]">
        ...
        <span
          className="scroll-total hidden font-mono text-[.8rem]"
          aria-hidden="true"
        >
          / {String(works.length).padStart(2, "0")}
        </span>
      </div>
      <div className="scroll-captions hidden">
        {works.map((work) => (
