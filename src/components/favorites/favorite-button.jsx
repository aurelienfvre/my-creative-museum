    ...
    <div>
      ...
      >
        <svg
          ...
          strokeWidth="1.4"
          aria-hidden="true"
          className={`shrink-0 transition-transform duration-300 motion-reduce:transition-none ${saved ? "scale-110 motion-safe:animate-[favorite-pop_450ms_ease-out]" : "scale-100"}`}
        >
